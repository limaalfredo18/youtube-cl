      ...
      >
        <div className="flex-1 mb-5">
          ...
          <input
            ...
            className="p-1 text-white border rounded"
            required
          />
        </div>
        ...
        <button
          ...
          className={`border-blue-700 bg-blue-700  px-12 py-2 mt-0 font-bold rounded-2xl ${
            title && video && image
              ? ""
              : "cursor-not-allowed text-gray-2000 border-blue-700 bg-blue-700"
          }`}
        >
          Upload
        </button>
